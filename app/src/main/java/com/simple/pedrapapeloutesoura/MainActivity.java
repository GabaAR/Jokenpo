package com.simple.pedrapapeloutesoura;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void escolhaUsuario(String escolhaUsuario){
            ...
            if(
                ...
                txtResultado.setText("Você perde! :(");
            } else if(
                    (escolhaUsuario == "tesoura"   && escolhaApp == "papel") ||
                    (escolhaUsuario == "papel"     && escolhaApp == "pedra") ||
                    (escolhaUsuario == "pedra" && escolhaApp == "tesoura") ){ //Usúario ganhador

                txtResultado.setText("Você Ganhou!!! ^-^");
            }
             else{ //Empate
                txtResultado.setText("Empate! -_-");
            }
